...
%This function was generated by loadlibrary.m parser version 1.1.6.37 on Wed Jun 25 12:18:25 2014
%perl options:'HRDL.i -outfile=picoHRDLMFile.m -thunkfile=PicoHRDL_thunk_pcwin64.c -header=HRDL.h'
ival={cell(1,0)}; % change 0 to the actual number of functions to preallocate the data.
structs=[];enuminfo=[];fcnNum=1;
fcns=struct('name',ival,'calltype',ival,'LHS',ival,'RHS',ival,'alias',ival,'thunkname', ival);
MfilePath=fileparts(mfilename('fullpath'));
ThunkLibName=fullfile(MfilePath,'PicoHRDL_thunk_pcwin64');
...
fcns.thunkname{fcnNum}='int16int16voidPtrvoidPtrint16Thunk';fcns.name{fcnNum}='HRDLGetMinMaxAdcCounts'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='int16'; fcns.RHS{fcnNum}={'int16', 'longPtr', 'longPtr', 'int16'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='int16int16longint16Thunk';fcns.name{fcnNum}='HRDLSetInterval'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='int16'; fcns.RHS{fcnNum}={'int16', 'long', 'int16'};fcnNum=fcnNum+1;
% short HRDLRun ( short handle , long nValues , short method ); 
fcns.thunkname{fcnNum}='int16int16longint16Thunk';fcns.name{fcnNum}='HRDLRun'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='int16'; fcns.RHS{fcnNum}={'int16', 'long', 'int16'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='longint16voidPtrvoidPtrlongThunk';fcns.name{fcnNum}='HRDLGetValues'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'int16', 'longPtr', 'int16Ptr', 'long'};fcnNum=fcnNum+1;
% long HRDLGetTimesAndValues ( short handle , long * times , long * values , short * overflow , long noOfValues ); 
fcns.thunkname{fcnNum}='longint16voidPtrvoidPtrvoidPtrlongThunk';fcns.name{fcnNum}='HRDLGetTimesAndValues'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'int16', 'longPtr', 'longPtr', 'int16Ptr', 'long'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='int16int16int16int16int16int16voidPtrvoidPtrThunk';fcns.name{fcnNum}='HRDLGetSingleValue'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='int16'; fcns.RHS{fcnNum}={'int16', 'int16', 'int16', 'int16', 'int16', 'int16Ptr', 'longPtr'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='int16int16voidPtrvoidPtrThunk';fcns.name{fcnNum}='HRDLGetSingleValueAsync'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='int16'; fcns.RHS{fcnNum}={'int16', 'longPtr', 'int16Ptr'};fcnNum=fcnNum+1;
